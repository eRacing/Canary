...
public interface ISignal<T> {
    /**
     * This method returns if the signal is continuous or not.
     *
     * @return Whether the signal is continuous or not.
     */
     ...
     *
     * TODO: confirm that the byte order adjust is valid
     *
