...
public abstract class AbstractSignal<T> implements ISignal<T> {
    /**
     * This minimum bit position in a message.
     */
    public static final int MINIMUM_BIT_POSITION = 0;

    /**
     * This maximum bit position in a message.
     */
    public static final int MAXIMUM_BIT_POSITION = 63;
